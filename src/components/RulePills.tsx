...
export function RulePills({ minChangePercent, maxFloat, minVolume }: RulePillsProps) {
  ...
  if (minChangePercent !== 0 && minChangePercent !== -10) { 
    pills.push(
      <Badge key="change" variant="outline" className="text-accent border-accent flex items-center"> {/* Accent is Electric Violet */}
  ...
  if (maxFloat !== 20000) { 
     pills.push(
      <Badge key="float" variant="outline" className="text-accent border-accent flex items-center"> {/* Accent is Electric Violet */}
  ...
  if (minVolume !== 0) {
     pills.push(
      <Badge key="volume" variant="outline" className="text-accent border-accent flex items-center"> {/* Accent is Electric Violet */}
