...
const initialColumnConfiguration: ColumnConfig<Stock>[] = [
  ...
  }},
  {
    ...
    align: 'left',
    defaultWidth: 240,
    description: "Latest News Sentiment",
    format: (sentimentValue: 'Positive' | 'Negative' | 'Neutral' | undefined, stock) => {
      const sentiment = stock.sentiment || 'Neutral';

      if (!stock.newsSnippet && !stock.newsSentimentPercent) {
        return <span className="text-xs text-muted-foreground/60 italic">No News</span>;
      }

      const getSentimentClasses = (s: typeof sentiment) => {
        switch (s) {
      ...
      const sentimentText = stock.newsSentimentPercent 
      ...
      return (
        <TooltipProvider delayDuration={200}>
          <Tooltip>
            ...
            {stock.newsSnippet && (
              <TooltipContent>
                <p className="max-w-xs">{stock.newsSnippet}</p>
              </TooltipContent>
            )}
          </Tooltip>
        </TooltipProvider>
...
export const initialMockStocks: Stock[] = [
  ...
  { id: '6', symbol: 'AMZN', name: 'Amazon.com, Inc.', price: 185.50, changePercent: 1.8, float: 10000, volume: 52.3, newsSnippet: 'Prime Day sales exceed expectations.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Positive', newsSentimentPercent: 95, topNewsKeyword: 'Sales Record', historicalPrices: [182.1, 183.5, 184.0, 185.8, 185.1, 186.2, 185.5], marketCap: 185.50 * 10000 * 1e6, avgVolume: 50.1, atr: 3.5, rsi: 62.0, vwap: 185.40, beta: 1.15, high52: 190.00, low52: 125.00, gapPercent: 0.4, shortFloat: 1.2, instOwn: 60.0, premarketChange: 0.25, peRatio: 55.0, dividendYield: 0.0, sector: 'Consumer Discretionary', earningsDate: '2024-08-01T00:00:00.000Z', analystRating: 'Buy' },
  { id: '7', symbol: 'SNOW', name: 'Snowflake Inc.', price: 120.00, changePercent: -2.1, float: 300, volume: 5.5, newsSnippet: 'Lowered guidance for next quarter.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Negative', newsSentimentPercent: 80, topNewsKeyword: 'Guidance', historicalPrices: [132.0, 131.5, 130.0, 129.5, 128.0, 127.5, 128.75], marketCap: 128.75 * 300 * 1e6, avgVolume: 6.2, atr: 4.1, rsi: 38.5, vwap: 129.00, beta: 1.4, high52: 210.00, low52: 120.00, gapPercent: -0.8, shortFloat: 5.5, instOwn: 70.5, premarketChange: -0.5, peRatio: -150.0, dividendYield: 0.0, sector: 'Technology', earningsDate: '2024-08-22T00:00:00.000Z', analystRating: 'Hold' },
  { id: '8', symbol: 'XOM', name: 'Exxon Mobil Corporation', price: 112.30, changePercent: 0.45, float: 4000, volume: 15.2, newsSnippet: 'Oil prices show slight increase.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 60, topNewsKeyword: 'Oil Prices', historicalPrices: [111.8, 112.0, 112.5, 112.1, 112.6, 112.4, 112.3], marketCap: 112.30 * 4000 * 1e6, avgVolume: 16.0, atr: 1.8, rsi: 53.0, vwap: 112.25, beta: 0.9, high52: 125.00, low52: 95.00, gapPercent: 0.1, shortFloat: 1.0, instOwn: 55.8, premarketChange: 0.05, peRatio: 12.3, dividendYield: 3.2, sector: 'Energy', earningsDate: '2024-07-26T00:00:00.000Z', analystRating: 'Hold' },
  { id: '9', symbol: 'LULU', name: 'Lululemon Athletica Inc.', price: 305.60, changePercent: 3.5, float: 120, volume: 2.1, newsSnippet: 'Strong international sales growth reported.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Positive', newsSentimentPercent: 90, topNewsKeyword: 'International Sales', historicalPrices: [295.0, 298.5, 300.0, 303.2, 301.8, 306.5, 305.6], marketCap: 305.60 * 120 * 1e6, avgVolume: 1.9, atr: 8.5, rsi: 68.3, vwap: 304.90, beta: 1.3, high52: 420.00, low52: 280.00, gapPercent: 1.1, shortFloat: 4.1, instOwn: 80.2, premarketChange: 0.7, peRatio: 30.5, dividendYield: 0.0, sector: 'Consumer Discretionary', earningsDate: '2024-09-05T00:00:00.000Z', analystRating: 'Buy' },
  { id: '10', symbol: 'BCTX', name: 'BriaCell Therapeutics Corp.', price: 5.15, changePercent: 15.2, float: 50, volume: 22.5, newsSnippet: 'Positive phase 2 trial results announced.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Positive', newsSentimentPercent: 98, topNewsKeyword: 'Trial Results', historicalPrices: [4.5, 4.6, 4.8, 5.0, 4.9, 5.2, 5.15], marketCap: 5.15 * 50 * 1e6, avgVolume: 5.0, atr: 0.75, rsi: 80.5, vwap: 5.05, beta: 2.1, high52: 10.50, low52: 2.00, gapPercent: 3.2, shortFloat: 18.0, instOwn: 30.1, premarketChange: 1.5, peRatio: -5.2, dividendYield: 0.0, sector: 'Healthcare', earningsDate: '2024-09-12T00:00:00.000Z', analystRating: 'Strong Buy' },
  { id: '11', symbol: 'CAT', name: 'Caterpillar Inc.', price: 328.40, changePercent: -0.25, float: 500, volume: 1.1, newsSnippet: 'Infrastructure spending bill faces delays.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Negative', newsSentimentPercent: 65, topNewsKeyword: 'Delays', historicalPrices: [329.0, 328.5, 328.8, 328.0, 328.6, 328.2, 328.4], marketCap: 328.40 * 500 * 1e6, avgVolume: 1.5, atr: 5.2, rsi: 48.0, vwap: 328.50, beta: 1.05, high52: 360.00, low52: 280.00, gapPercent: -0.1, shortFloat: 0.9, instOwn: 72.3, premarketChange: 0.0, peRatio: 15.7, dividendYield: 1.6, sector: 'Industrials', earningsDate: '2024-08-02T00:00:00.000Z', analystRating: 'Hold' },
  { id: '12', symbol: 'JPM', name: 'JPMorgan Chase & Co.', price: 198.88, changePercent: 0.05, float: 2800, volume: 8.3, newsSnippet: 'Federal Reserve maintains current interest rates.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Neutral', newsSentimentPercent: 51, topNewsKeyword: 'Interest Rates', historicalPrices: [198.5, 199.0, 198.7, 198.9, 198.6, 199.1, 198.88], marketCap: 198.88 * 2800 * 1e6, avgVolume: 9.0, atr: 2.5, rsi: 51.2, vwap: 198.85, beta: 0.95, high52: 210.00, low52: 150.00, gapPercent: 0.0, shortFloat: 0.7, instOwn: 78.0, premarketChange: -0.02, peRatio: 11.5, dividendYield: 2.2, sector: 'Financials', earningsDate: '2024-07-12T00:00:00.000Z', analystRating: 'Buy' },
  { id: '13', symbol: 'AVGO', name: 'Broadcom Inc.', price: 1605.70, changePercent: 2.2, float: 400, volume: 2.3, newsSnippet: 'Demand for AI chips continues to surge.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Positive', newsSentimentPercent: 93, topNewsKeyword: 'AI Chips', historicalPrices: [1570.0, 1585.5, 1590.0, 1610.2, 1600.8, 1615.5, 1605.7], marketCap: 1605.70 * 400 * 1e6, avgVolume: 2.0, atr: 35.0, rsi: 66.7, vwap: 1603.00, beta: 1.25, high52: 1700.00, low52: 800.00, gapPercent: 0.6, shortFloat: 1.8, instOwn: 85.0, premarketChange: 0.4, peRatio: 45.3, dividendYield: 1.2, sector: 'Technology', earningsDate: '2024-09-04T00:00:00.000Z', analystRating: 'Buy' },
  { id: '14', symbol: 'KSS', name: "Kohl's Corporation", price: 23.50, changePercent: -1.5, float: 110, volume: 3.1, newsSnippet: 'Retail sales disappoint for the month.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Negative', newsSentimentPercent: 78, topNewsKeyword: 'Retail Sales', historicalPrices: [24.0, 23.8, 23.6, 23.4, 23.7, 23.3, 23.5], marketCap: 23.50 * 110 * 1e6, avgVolume: 3.5, atr: 0.9, rsi: 35.0, vwap: 23.55, beta: 1.6, high52: 35.00, low52: 20.00, gapPercent: -0.5, shortFloat: 12.5, instOwn: 63.4, premarketChange: -0.2, peRatio: 10.1, dividendYield: 8.5, sector: 'Consumer Discretionary', earningsDate: '2024-08-20T00:00:00.000Z', analystRating: 'Sell' },
  { id: '15', symbol: 'RIVN', name: 'Rivian Automotive, Inc.', price: 10.80, changePercent: -4.2, float: 850, volume: 33.8, newsSnippet: 'Production targets missed, stock downgraded.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Negative', newsSentimentPercent: 95, topNewsKeyword: 'Production Miss', historicalPrices: [11.5, 11.2, 11.0, 10.7, 10.9, 10.6, 10.8], marketCap: 10.80 * 850 * 1e6, avgVolume: 30.0, atr: 0.8, rsi: 30.1, vwap: 10.85, beta: 2.3, high52: 25.00, low52: 8.50, gapPercent: -1.8, shortFloat: 25.2, instOwn: 40.7, premarketChange: -0.9, peRatio: -1.5, dividendYield: 0.0, sector: 'Consumer Discretionary', earningsDate: '2024-08-07T00:00:00.000Z', analystRating: 'Sell' },
  { id: '16', symbol: 'CRM', name: 'Salesforce, Inc.', price: 232.10, changePercent: 1.15, float: 920, volume: 4.2, newsSnippet: 'Acquires smaller AI startup.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Positive', newsSentimentPercent: 70, topNewsKeyword: 'Acquisition', historicalPrices: [229.0, 230.5, 231.0, 232.5, 231.7, 233.0, 232.1], marketCap: 232.10 * 920 * 1e6, avgVolume: 4.0, atr: 5.5, rsi: 58.0, vwap: 232.00, beta: 1.1, high52: 280.00, low52: 180.00, gapPercent: 0.3, shortFloat: 2.0, instOwn: 88.1, premarketChange: 0.15, peRatio: 70.2, dividendYield: 0.0, sector: 'Technology', earningsDate: '2024-08-28T00:00:00.000Z', analystRating: 'Buy' },
  { id: '17', symbol: 'NEE', name: 'NextEra Energy, Inc.', price: 72.50, changePercent: 0.75, float: 2000, volume: 10.5, newsSnippet: 'Invests heavily in new solar projects.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Positive', newsSentimentPercent: 82, topNewsKeyword: 'Solar Investment', historicalPrices: [71.8, 72.0, 72.3, 72.8, 72.4, 72.9, 72.5], marketCap: 72.50 * 2000 * 1e6, avgVolume: 11.2, atr: 1.2, rsi: 54.5, vwap: 72.45, beta: 0.7, high52: 85.00, low52: 60.00, gapPercent: 0.2, shortFloat: 0.5, instOwn: 79.8, premarketChange: 0.1, peRatio: 18.9, dividendYield: 2.8, sector: 'Utilities', earningsDate: '2024-07-23T00:00:00.000Z', analystRating: 'Hold' },
  { id: '18', symbol: 'GTHX', name: 'G1 Therapeutics, Inc.', price: 14.90, changePercent: -0.8, float: 80, volume: 0.45, newsSnippet: undefined, lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: undefined, newsSentimentPercent: undefined, topNewsKeyword: undefined, historicalPrices: [15.2, 15.1, 15.0, 14.8, 14.95, 14.7, 14.9], marketCap: 14.90 * 80 * 1e6, avgVolume: 0.6, atr: 1.1, rsi: 28.0, vwap: 14.92, beta: 1.7, high52: 30.00, low52: 10.00, gapPercent: -0.1, shortFloat: 8.2, instOwn: 50.3, premarketChange: 0.05, peRatio: -8.1, dividendYield: 0.0, sector: 'Healthcare', earningsDate: '2024-08-06T00:00:00.000Z', analystRating: 'Hold' },
  { id: '19', symbol: 'UAL', name: 'United Airlines Holdings, Inc.', price: 51.20, changePercent: 2.9, float: 320, volume: 7.2, newsSnippet: 'Travel demand remains strong for summer.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Positive', newsSentimentPercent: 85, topNewsKeyword: 'Travel Demand', historicalPrices: [49.8, 50.1, 50.5, 51.5, 51.0, 51.8, 51.2], marketCap: 51.20 * 320 * 1e6, avgVolume: 6.5, atr: 1.5, rsi: 60.7, vwap: 51.10, beta: 1.5, high52: 60.00, low52: 35.00, gapPercent: 0.7, shortFloat: 3.3, instOwn: 68.9, premarketChange: 0.3, peRatio: 5.8, dividendYield: 0.0, sector: 'Industrials', earningsDate: '2024-07-16T00:00:00.000Z', analystRating: 'Buy' },
  { id: '20', symbol: 'RBLX', name: 'Roblox Corporation', price: 35.75, changePercent: 0.1, float: 550, volume: 10.1, newsSnippet: 'User engagement metrics stable.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 50, topNewsKeyword: 'User Metrics', historicalPrices: [35.5, 35.6, 35.8, 35.7, 35.9, 35.65, 35.75], marketCap: 35.75 * 550 * 1e6, avgVolume: 12.0, atr: 1.3, rsi: 50.2, vwap: 35.70, beta: 1.9, high52: 50.00, low52: 25.00, gapPercent: 0.0, shortFloat: 7.8, instOwn: 73.5, premarketChange: -0.05, peRatio: -20.3, dividendYield: 0.0, sector: 'Communication Services', earningsDate: '2024-08-08T00:00:00.000Z', analystRating: 'Hold' },
  { id: '21', symbol: 'PYPL', name: 'PayPal Holdings, Inc.', price: 60.10, changePercent: -0.5, float: 1100, volume: 12.5, newsSnippet: 'New CEO outlines turnaround plan.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Neutral', newsSentimentPercent: 60, topNewsKeyword: 'Turnaround Plan', historicalPrices: [60.5, 60.2, 59.8, 60.3, 60.0, 60.15, 60.10], marketCap: 60.10 * 1100 * 1e6, avgVolume: 15.0, atr: 1.8, rsi: 45.0, vwap: 60.05, beta: 1.3, high52: 80.00, low52: 50.00, gapPercent: -0.2, shortFloat: 2.5, instOwn: 70.0, premarketChange: -0.1, peRatio: 15.1, dividendYield: 0.0, sector: 'Financials', earningsDate: '2024-08-01T00:00:00.000Z', analystRating: 'Hold' },
  { id: '22', symbol: 'INTC', name: 'Intel Corporation', price: 30.50, changePercent: 1.2, float: 4200, volume: 45.0, newsSnippet: 'Foundry services gain new customer.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Positive', newsSentimentPercent: 72, topNewsKeyword: 'Foundry', historicalPrices: [30.0, 30.2, 30.6, 30.4, 30.8, 30.3, 30.50], marketCap: 30.50 * 4200 * 1e6, avgVolume: 50.0, atr: 0.9, rsi: 58.0, vwap: 30.45, beta: 1.0, high52: 50.00, low52: 25.00, gapPercent: 0.3, shortFloat: 1.1, instOwn: 65.0, premarketChange: 0.15, peRatio: 32.0, dividendYield: 1.8, sector: 'Technology', earningsDate: '2024-07-25T00:00:00.000Z', analystRating: 'Hold' },
  { id: '23', symbol: 'DIS', name: 'The Walt Disney Company', price: 102.00, changePercent: 0.8, float: 1800, volume: 8.0, newsSnippet: 'Streaming subscriber growth slows.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 45, topNewsKeyword: 'Subscribers', historicalPrices: [101.0, 101.5, 102.5, 101.8, 102.2, 102.1, 102.00], marketCap: 102.00 * 1800 * 1e6, avgVolume: 10.0, atr: 2.5, rsi: 52.0, vwap: 101.90, beta: 1.2, high52: 120.00, low52: 80.00, gapPercent: 0.1, shortFloat: 0.9, instOwn: 68.0, premarketChange: 0.05, peRatio: 110.5, dividendYield: 0.3, sector: 'Communication Services', earningsDate: '2024-08-06T00:00:00.000Z', analystRating: 'Hold' },
  { id: '24', symbol: 'BA', name: 'The Boeing Company', price: 175.00, changePercent: -1.8, float: 580, volume: 5.5, newsSnippet: 'Production delays on key aircraft model.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Negative', newsSentimentPercent: 88, topNewsKeyword: 'Production Delays', historicalPrices: [178.0, 177.0, 176.5, 175.5, 176.0, 174.5, 175.00], marketCap: 175.00 * 580 * 1e6, avgVolume: 6.0, atr: 4.0, rsi: 38.0, vwap: 175.20, beta: 1.4, high52: 250.00, low52: 150.00, gapPercent: -0.5, shortFloat: 3.0, instOwn: 60.0, premarketChange: -0.3, peRatio: -50.2, dividendYield: 0.0, sector: 'Industrials', earningsDate: '2024-07-24T00:00:00.000Z', analystRating: 'Sell' },
  { id: '25', symbol: 'AMD', name: 'Advanced Micro Devices, Inc.', price: 160.75, changePercent: 3.1, float: 1600, volume: 60.0, newsSnippet: 'New AI chip outperforms competitors.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Positive', newsSentimentPercent: 91, topNewsKeyword: 'AI Chip', historicalPrices: [155.0, 157.0, 159.0, 158.0, 161.0, 160.0, 160.75], marketCap: 160.75 * 1600 * 1e6, avgVolume: 55.0, atr: 5.0, rsi: 65.0, vwap: 160.50, beta: 1.5, high52: 200.00, low52: 100.00, gapPercent: 0.8, shortFloat: 1.5, instOwn: 72.0, premarketChange: 0.4, peRatio: 230.0, dividendYield: 0.0, sector: 'Technology', earningsDate: '2024-07-30T00:00:00.000Z', analystRating: 'Buy' },
  { id: '26', symbol: 'CVNA', name: 'Carvana Co.', price: 115.20, changePercent: 8.5, float: 70, volume: 15.0, newsSnippet: 'Short squeeze potential noted by analysts.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Positive', newsSentimentPercent: 68, topNewsKeyword: 'Short Squeeze', historicalPrices: [105.0, 108.0, 112.0, 110.0, 116.0, 114.0, 115.20], marketCap: 115.20 * 70 * 1e6, avgVolume: 10.0, atr: 10.0, rsi: 78.0, vwap: 114.50, beta: 2.5, high52: 150.00, low52: 10.00, gapPercent: 2.0, shortFloat: 40.0, instOwn: 50.0, premarketChange: 1.5, peRatio: -10.8, dividendYield: 0.0, sector: 'Consumer Discretionary', earningsDate: '2024-08-01T00:00:00.000Z', analystRating: 'Hold' },
  { id: '27', symbol: 'PFE', name: 'Pfizer Inc.', price: 28.30, changePercent: 0.2, float: 5600, volume: 25.0, newsSnippet: 'Positive trial results for new vaccine.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Positive', newsSentimentPercent: 89, topNewsKeyword: 'Vaccine Trial', historicalPrices: [28.0, 28.1, 28.4, 28.2, 28.5, 28.25, 28.30], marketCap: 28.30 * 5600 * 1e6, avgVolume: 30.0, atr: 0.7, rsi: 50.0, vwap: 28.28, beta: 0.8, high52: 45.00, low52: 25.00, gapPercent: 0.0, shortFloat: 0.5, instOwn: 75.0, premarketChange: 0.02, peRatio: 70.5, dividendYield: 5.9, sector: 'Healthcare', earningsDate: '2024-07-31T00:00:00.000Z', analystRating: 'Buy' },
  { id: '28', symbol: 'UBER', name: 'Uber Technologies, Inc.', price: 70.60, changePercent: -0.9, float: 2000, volume: 18.0, newsSnippet: 'Regulatory concerns in European markets.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Negative', newsSentimentPercent: 70, topNewsKeyword: 'Regulation', historicalPrices: [71.5, 71.0, 70.8, 70.5, 70.9, 70.4, 70.60], marketCap: 70.60 * 2000 * 1e6, avgVolume: 20.0, atr: 2.0, rsi: 42.0, vwap: 70.65, beta: 1.6, high52: 85.00, low52: 40.00, gapPercent: -0.3, shortFloat: 1.8, instOwn: 78.0, premarketChange: -0.1, peRatio: 105.0, dividendYield: 0.0, sector: 'Industrials', earningsDate: '2024-08-06T00:00:00.000Z', analystRating: 'Buy' },
  { id: '29', symbol: 'SHOP', name: 'Shopify Inc.', price: 65.40, changePercent: 1.5, float: 1200, volume: 7.0, newsSnippet: 'Announces new features for merchants.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Positive', newsSentimentPercent: 75, topNewsKeyword: 'New Features', historicalPrices: [64.0, 64.5, 65.0, 65.8, 65.2, 65.5, 65.40], marketCap: 65.40 * 1200 * 1e6, avgVolume: 9.0, atr: 2.2, rsi: 60.0, vwap: 65.30, beta: 1.7, high52: 90.00, low52: 45.00, gapPercent: 0.4, shortFloat: 2.2, instOwn: 60.0, premarketChange: 0.2, peRatio: -300.0, dividendYield: 0.0, sector: 'Technology', earningsDate: '2024-08-01T00:00:00.000Z', analystRating: 'Hold' },
  { id: '30', symbol: 'SQ', name: 'Block, Inc.', price: 64.80, changePercent: -2.2, float: 500, volume: 10.0, newsSnippet: 'Competition heating up in payment space.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Negative', newsSentimentPercent: 62, topNewsKeyword: 'Competition', historicalPrices: [66.5, 66.0, 65.5, 65.0, 65.2, 64.5, 64.80], marketCap: 64.80 * 500 * 1e6, avgVolume: 12.0, atr: 2.5, rsi: 35.0, vwap: 64.90, beta: 1.9, high52: 100.00, low52: 40.00, gapPercent: -0.7, shortFloat: 5.0, instOwn: 67.0, premarketChange: -0.4, peRatio: 80.2, dividendYield: 0.0, sector: 'Financials', earningsDate: '2024-08-01T00:00:00.000Z', analystRating: 'Hold' },
  { id: '31', symbol: 'ZM', name: 'Zoom Video Communications, Inc.', price: 58.00, changePercent: 0.1, float: 280, volume: 4.0, newsSnippet: 'Enterprise adoption continues steadily.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 55, topNewsKeyword: 'Adoption', historicalPrices: [57.5, 57.8, 58.2, 57.9, 58.1, 58.05, 58.00], marketCap: 58.00 * 280 * 1e6, avgVolume: 5.0, atr: 1.5, rsi: 48.0, vwap: 57.95, beta: 1.4, high52: 80.00, low52: 50.00, gapPercent: 0.0, shortFloat: 3.5, instOwn: 55.0, premarketChange: 0.01, peRatio: 28.1, dividendYield: 0.0, sector: 'Technology', earningsDate: '2024-08-19T00:00:00.000Z', analystRating: 'Hold' },
  { id: '32', symbol: 'COIN', name: 'Coinbase Global, Inc.', price: 225.50, changePercent: 5.2, float: 200, volume: 12.0, newsSnippet: 'Bitcoin price surge boosts crypto stocks.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Positive', newsSentimentPercent: 80, topNewsKeyword: 'Crypto Rally', historicalPrices: [210.0, 215.0, 220.0, 218.0, 226.0, 224.0, 225.50], marketCap: 225.50 * 200 * 1e6, avgVolume: 10.0, atr: 15.0, rsi: 72.0, vwap: 224.80, beta: 2.8, high52: 300.00, low52: 50.00, gapPercent: 1.5, shortFloat: 10.0, instOwn: 45.0, premarketChange: 0.9, peRatio: 50.7, dividendYield: 0.0, sector: 'Financials', earningsDate: '2024-08-07T00:00:00.000Z', analystRating: 'Buy' },
  { id: '33', symbol: 'NFLX', name: 'Netflix, Inc.', price: 640.00, changePercent: -0.3, float: 430, volume: 2.5, newsSnippet: 'Password sharing crackdown impact unclear.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 50, topNewsKeyword: 'Password Sharing', historicalPrices: [642.0, 641.0, 638.0, 640.5, 639.0, 640.2, 640.00], marketCap: 640.00 * 430 * 1e6, avgVolume: 3.0, atr: 12.0, rsi: 49.0, vwap: 639.80, beta: 1.1, high52: 700.00, low52: 300.00, gapPercent: -0.1, shortFloat: 0.7, instOwn: 80.0, premarketChange: -0.05, peRatio: 45.9, dividendYield: 0.0, sector: 'Communication Services', earningsDate: '2024-07-18T00:00:00.000Z', analystRating: 'Hold' },
  { id: '34', symbol: 'WMT', name: 'Walmart Inc.', price: 66.50, changePercent: 0.4, float: 2200, volume: 15.0, newsSnippet: 'Retail giant reports steady sales.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 65, topNewsKeyword: 'Sales Report', historicalPrices: [66.0, 66.2, 66.6, 66.4, 66.8, 66.45, 66.50], marketCap: 66.50 * 2200 * 1e6, avgVolume: 18.0, atr: 1.0, rsi: 55.0, vwap: 66.48, beta: 0.7, high52: 70.00, low52: 50.00, gapPercent: 0.1, shortFloat: 0.4, instOwn: 40.0, premarketChange: 0.03, peRatio: 28.0, dividendYield: 1.3, sector: 'Consumer Staples', earningsDate: '2024-08-15T00:00:00.000Z', analystRating: 'Buy' },
  { id: '35', symbol: 'COST', name: 'Costco Wholesale Corporation', price: 840.20, changePercent: 0.9, float: 440, volume: 1.0, newsSnippet: 'Membership renewal rates remain high.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Positive', newsSentimentPercent: 94, topNewsKeyword: 'Membership', historicalPrices: [830.0, 835.0, 838.0, 842.0, 839.5, 841.0, 840.20], marketCap: 840.20 * 440 * 1e6, avgVolume: 1.2, atr: 10.0, rsi: 68.0, vwap: 840.00, beta: 0.9, high52: 850.00, low52: 500.00, gapPercent: 0.2, shortFloat: 0.6, instOwn: 70.0, premarketChange: 0.1, peRatio: 49.8, dividendYield: 0.5, sector: 'Consumer Staples', earningsDate: '2024-09-26T00:00:00.000Z', analystRating: 'Buy' },
  { id: '36', symbol: 'GE', name: 'General Electric Company', price: 165.20, changePercent: -0.5, float: 1080, volume: 4.1, newsSnippet: 'Aerospace division shows strong growth.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Positive', newsSentimentPercent: 81, topNewsKeyword: 'Aerospace', marketCap: 178.42e9, avgVolume: 5.2, atr: 3.153, rsi: 55.3, vwap: 165.10, beta: 1.02, high52: 180.50, low52: 130.75, gapPercent: -0.1, shortFloat: 1.2, instOwn: 78.5, premarketChange: -0.05, peRatio: 20.5, dividendYield: 0.7, sector: 'Industrials', earningsDate: '2024-07-23T00:00:00.000Z', analystRating: 'Hold' },
  { id: '37', symbol: 'BAC', name: 'Bank of America Corporation', price: 39.80, changePercent: 1.2, float: 8100, volume: 35.5, newsSnippet: 'Bank earnings exceed expectations.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Positive', newsSentimentPercent: 87, topNewsKeyword: 'Earnings', marketCap: 314.42e9, avgVolume: 40.1, atr: 0.752, rsi: 62.1, vwap: 39.75, beta: 1.15, high52: 42.10, low52: 30.50, gapPercent: 0.3, shortFloat: 0.8, instOwn: 70.2, premarketChange: 0.15, peRatio: 11.8, dividendYield: 2.4, sector: 'Financials', earningsDate: '2024-07-16T00:00:00.000Z', analystRating: 'Buy' },
  { id: '38', symbol: 'XLE', name: 'Energy Select Sector SPDR Fund', price: 92.75, changePercent: 0.3, float: 0, volume: 12.3, newsSnippet: 'Energy sector ETF tracking oil prices.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 50, topNewsKeyword: 'General', marketCap: 40.00e9, avgVolume: 15.0, atr: 1.205, rsi: 58.0, vwap: 92.70, beta: 1.0, high52: 95.80, low52: 75.20, gapPercent: 0.05, shortFloat: 2.5, instOwn: 60.0, premarketChange: 0.03, peRatio: 10.5, dividendYield: 3.5, sector: 'ETF', earningsDate: undefined, analystRating: 'Hold' },
  { id: '39', symbol: 'FSR', name: 'Fisker Inc.', price: 0.152, changePercent: -5.2, float: 350, volume: 80.1, newsSnippet: 'EV company faces bankruptcy concerns.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Negative', newsSentimentPercent: 99, topNewsKeyword: 'Bankruptcy', marketCap: 53.2e6, avgVolume: 65.0, atr: 0.025, rsi: 25.5, vwap: 0.155, beta: 2.5, high52: 2.50, low52: 0.10, gapPercent: -1.5, shortFloat: 35.0, instOwn: 20.5, premarketChange: -0.8, peRatio: -0.1, dividendYield: 0.0, sector: 'Consumer Discretionary', earningsDate: '2024-08-05T00:00:00.000Z', analystRating: 'Strong Sell' },
  { id: '40', symbol: 'PLTR', name: 'Palantir Technologies Inc.', price: 25.80, changePercent: 2.8, float: 1800, volume: 45.6, newsSnippet: 'New government contracts secured.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Positive', newsSentimentPercent: 90, topNewsKeyword: 'Contracts', marketCap: 55.73e9, avgVolume: 50.2, atr: 0.95, rsi: 68.2, vwap: 25.75, beta: 1.8, high52: 28.10, low52: 15.50, gapPercent: 0.7, shortFloat: 5.1, instOwn: 35.0, premarketChange: 0.4, peRatio: 200.5, dividendYield: 0.0, sector: 'Technology', earningsDate: '2024-08-05T00:00:00.000Z', analystRating: 'Buy' },
  { id: '41', symbol: 'SOFI', name: 'SoFi Technologies, Inc.', price: 6.95, changePercent: -1.1, float: 900, volume: 22.3, newsSnippet: 'Fintech company reports mixed earnings.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Negative', newsSentimentPercent: 58, topNewsKeyword: 'Earnings', marketCap: 6.5e9, avgVolume: 25.0, atr: 0.353, rsi: 40.7, vwap: 6.98, beta: 1.9, high52: 10.50, low52: 5.80, gapPercent: -0.2, shortFloat: 12.3, instOwn: 40.1, premarketChange: -0.1, peRatio: -30.2, dividendYield: 0.0, sector: 'Financials', earningsDate: '2024-07-29T00:00:00.000Z', analystRating: 'Hold' },
  { id: '42', symbol: 'RIOT', name: 'Riot Platforms, Inc.', price: 10.25, changePercent: 4.3, float: 220, volume: 18.9, newsSnippet: 'Bitcoin mining stock follows crypto rally.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Positive', newsSentimentPercent: 77, topNewsKeyword: 'Crypto Rally', marketCap: 2.26e9, avgVolume: 20.5, atr: 0.851, rsi: 70.1, vwap: 10.20, beta: 3.1, high52: 15.50, low52: 5.10, gapPercent: 1.1, shortFloat: 22.8, instOwn: 30.7, premarketChange: 0.6, peRatio: -15.8, dividendYield: 0.0, sector: 'Financials', earningsDate: '2024-08-12T00:00:00.000Z', analystRating: 'Hold' },
  { id: '43', symbol: 'MCD', name: "McDonald's Corporation", price: 255.80, changePercent: 0.15, float: 720, volume: 2.1, newsSnippet: 'McDonalds plans new menu items.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 52, topNewsKeyword: 'General', marketCap: 186.73e9, avgVolume: 2.5, atr: 3.506, rsi: 52.3, vwap: 255.75, beta: 0.6, high52: 290.10, low52: 240.50, gapPercent: 0.0, shortFloat: 0.7, instOwn: 80.1, premarketChange: 0.03, peRatio: 23.5, dividendYield: 2.5, sector: 'Consumer Discretionary', earningsDate: '2024-07-29T00:00:00.000Z', analystRating: 'Buy' },
  { id: '44', symbol: 'PG', name: 'Procter & Gamble Company', price: 168.30, changePercent: -0.2, float: 2300, volume: 5.3, newsSnippet: 'Procter & Gamble faces commodity cost pressures.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Negative', newsSentimentPercent: 71, topNewsKeyword: 'Commodity Costs', marketCap: 399.5e9, avgVolume: 6.0, atr: 2.152, rsi: 48.8, vwap: 168.35, beta: 0.4, high52: 175.20, low52: 140.80, gapPercent: -0.05, shortFloat: 0.5, instOwn: 65.7, premarketChange: 0.0, peRatio: 26.7, dividendYield: 2.3, sector: 'Consumer Staples', earningsDate: '2024-07-30T00:00:00.000Z', analystRating: 'Hold' },
  { id: '45', symbol: 'LLY', name: 'Eli Lilly and Company', price: 880.50, changePercent: 1.5, float: 940, volume: 1.8, newsSnippet: 'Eli Lilly drug trial shows positive results.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', sentiment: 'Positive', newsSentimentPercent: 96, topNewsKeyword: 'Drug Trial', marketCap: 834.47e9, avgVolume: 2.2, atr: 15.208, rsi: 75.6, vwap: 879.80, beta: 0.3, high52: 900.00, low52: 450.20, gapPercent: 0.4, shortFloat: 0.4, instOwn: 82.3, premarketChange: 0.25, peRatio: 130.2, dividendYield: 0.6, sector: 'Healthcare', earningsDate: '2024-08-06T00:00:00.000Z', analystRating: 'Strong Buy' },
  { id: '46', symbol: 'JNJ', name: 'Johnson & Johnson', price: 148.90, changePercent: 0.05, float: 2400, volume: 7.2, newsSnippet: 'Johnson & Johnson consumer health spinoff complete.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 60, topNewsKeyword: 'Spinoff', marketCap: 349.41e9, avgVolume: 8.0, atr: 1.857, rsi: 50.1, vwap: 148.85, beta: 0.5, high52: 160.30, low52: 135.70, gapPercent: 0.01, shortFloat: 0.6, instOwn: 70.9, premarketChange: 0.0, peRatio: 22.7, dividendYield: 3.2, sector: 'Healthcare', earningsDate: '2024-07-17T00:00:00.000Z', analystRating: 'Buy' },
  { id: '47', symbol: 'TGT', name: 'Target Corporation', price: 145.60, changePercent: -1.8, float: 460, volume: 3.1, newsSnippet: 'Target warns of slowing consumer demand.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Negative', newsSentimentPercent: 84, topNewsKeyword: 'Consumer Demand', marketCap: 67.7e9, avgVolume: 3.5, atr: 2.904, rsi: 38.5, vwap: 145.70, beta: 1.1, high52: 170.20, low52: 120.50, gapPercent: -0.5, shortFloat: 3.1, instOwn: 75.8, premarketChange: -0.3, peRatio: 18.5, dividendYield: 3.0, sector: 'Consumer Staples', earningsDate: '2024-08-21T00:00:00.000Z', analystRating: 'Sell' },
  { id: '48', symbol: 'SMCI', name: 'Super Micro Computer, Inc.', price: 810.20, changePercent: 3.3, float: 50, volume: 6.5, newsSnippet: 'Super Micro Computer benefits from AI server demand.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Positive', newsSentimentPercent: 91, topNewsKeyword: 'AI Servers', marketCap: 47.8e9, avgVolume: 5.8, atr: 40.501, rsi: 60.2, vwap: 808.00, beta: 2.9, high52: 1200.00, low52: 200.50, gapPercent: 0.9, shortFloat: 15.2, instOwn: 55.1, premarketChange: 0.7, peRatio: 45.1, dividendYield: 0.0, sector: 'Technology', earningsDate: '2024-08-13T00:00:00.000Z', analystRating: 'Hold' },
  { id: '49', symbol: 'DJT', name: 'Trump Media & Technology Group Corp.', price: 35.70, changePercent: -4.1, float: 70, volume: 5.2, newsSnippet: 'Trump Media stock experiences volatility.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'fire', sentiment: 'Negative', newsSentimentPercent: 75, topNewsKeyword: 'Volatility', marketCap: 4.92e9, avgVolume: 6.0, atr: 3.108, rsi: 33.7, vwap: 35.80, beta: 3.5, high52: 70.00, low52: 20.10, gapPercent: -1.2, shortFloat: 18.9, instOwn: 10.3, premarketChange: -0.9, peRatio: -5.0, dividendYield: 0.0, sector: 'Communication Services', earningsDate: '2024-08-14T00:00:00.000Z', analystRating: 'Strong Sell' },
  { id: '50', symbol: 'SPY', name: 'SPDR S&P 500 ETF Trust', price: 547.80, changePercent: 0.22, float: 0, volume: 45.1, newsSnippet: 'S&P 500 ETF tracks broad market movement.', lastUpdated: MOCK_INITIAL_TIMESTAMP, sentiment: 'Neutral', newsSentimentPercent: 50, topNewsKeyword: 'General', marketCap: 503.01e9, avgVolume: 50.0, atr: 4.205, rsi: 65.3, vwap: 547.70, beta: 1.0, high52: 550.10, low52: 400.50, gapPercent: 0.05, shortFloat: 1.0, instOwn: 50.0, premarketChange: 0.03, peRatio: 25.0, dividendYield: 1.3, sector: 'ETF', earningsDate: undefined, analystRating: 'Hold' },
  {
    id: '51',
    symbol: 'TPL',
    ...
    float: 24,
    volume: 1.2,
    newsSnippet: 'TPL gains on strong energy sector performance.',
    lastUpdated: MOCK_INITIAL_TIMESTAMP,
    catalystType: 'news',
    sentiment: 'Positive',
    newsSentimentPercent: 80,
    topNewsKeyword: 'Energy Sector',
    ...
    dividendYield: 0.5,
    sector: 'Energy',
    earningsDate: '2024-08-10T00:00:00.000Z',
    open: 820.10,
    high: 840.20,
    low: 819.50,
    prevClose: 816.67,
                        ...
                        {displayedColumns.map((col) => (
                          ...
                          >
                            ...
                            <div
                                ...
                                className={cn(
                                    "absolute top-0 right-0 h-full w-2 cursor-col-resize z-20 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity",
                                    resizingColumnKey === col.key && "opacity-100"
                                )}
                                title={`Resize ${col.label} column`}
                            >
                                <div className={cn("h-1/2 w-0.5 bg-primary rounded-full transition-all", resizingColumnKey === col.key && "bg-purple-500 shadow-[0_0_8px_2px_#A855F7]")} />
                            </div>
                          </TableHead>
                        ))}
                      </TableRow>
