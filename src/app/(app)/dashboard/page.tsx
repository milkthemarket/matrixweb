...
export const initialMockStocks: Stock[] = [
  ...
  { id: '45', symbol: 'LLY', name: 'Eli Lilly and Company', price: 880.50, changePercent: 1.5, float: 940, volume: 1.8, newsSnippet: 'Eli Lilly drug trial shows positive results.', lastUpdated: MOCK_INITIAL_TIMESTAMP, catalystType: 'news', marketCap: 834.47 * 10^9, avgVolume: 2.2, atr: 15.208, rsi: 75.6, vwap: 879.80, beta: 0.3, high52: 900.00, low52: 450.20, gapPercent: 0.4, shortFloat: 0.4, instOwn: 82.3, premarketChange: 0.25, peRatio: 130.2, dividendYield: 0.6, sector: 'Healthcare', earningsDate: '2024-08-06T00:00:00.000Z', analystRating: 'Strong Buy' },
